...
🔑 Key Insights
Below are the major insights the dashboard surfaces, structured the way hiring managers expect.
...
This project highlights competency in the following:
✔ SQL Skills
Building customer-level LTV models
Preparing channel-level and campaign-level aggregations
Quartile + cohort-style segmentation
Product association rule groundwork (support, confidence, lift-ready)
Multi-table joins for marketing data modeling
✔ Tableau Skills
Interactive dashboards
KPIs, calculated fields, cohort charts
Demographic segmentation
Channel and product comparisons
Co-purchase matrix visualization
Multi-level drilldown
✔ Marketing Analytics Skills
Campaign attribution
Segment & persona analysis
RFM-style thinking
Cohort/Quartile comparisons
Product cross-sell and revenue growth analysis
